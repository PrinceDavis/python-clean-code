...
def test_response_success_is_type_and_value(response_value):
...
def test_response_failure_has_type_and_message(response_type, response_message):
    ...
    assert response_message == response_message
...
def test_response_failure_from_invalid_request_objet_with_error():
